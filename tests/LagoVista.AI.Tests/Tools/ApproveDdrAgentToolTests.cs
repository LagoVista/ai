...
{
    [TestFixture]
    public class ApproveDdrAgentToolTests
    {
        ...
        [Test]
        public async Task ApproveDdr_MissingIdentifier_ReturnsError()
        {
        ...
        [Test]
        public async Task ApproveDdr_GoalNotApproved_ReturnsError()
        {
            ...
            Assert.That(result.Successful, Is.False);
            Assert.That(result.ErrorMessage, Is.EqualTo("DDR cannot be approved because the goal has not been approved."));
        }

        [Test]
        public async Task ApproveDdr_Valid_SetsApprovedStatus()
        {
            var ddr = new DetailedDesignReview
            {
                Tla = "SYS",
            ...
            Assert.That(ddr.Status, Is.EqualTo("Approved"));
            Assert.That(ddr.ApprovedBy, Is.Not.Null);
        }

        [Test]
        public void ApproveDdr_GetSchema_ReturnsObject()
        {
            var schema = ApproveDdrAgentTool.GetSchema();
