...
{
    [TestFixture]
    public class UpdateChapterSummaryAgentToolTests
    {
        ...
        [Test]
        public async Task UpdateChapterSummary_MissingIdentifier_ReturnsError()
        {
            var tool = new UpdateChapterSummaryAgentTool(_ddrManager.Object, _logger.Object);
        ...
        [Test]
        public async Task UpdateChapterSummary_MissingChapterId_ReturnsError()
        {
            var tool = new UpdateChapterSummaryAgentTool(_ddrManager.Object, _logger.Object);
        ...
        [Test]
        public async Task UpdateChapterSummary_MissingSummary_ReturnsError()
        {
            var tool = new UpdateChapterSummaryAgentTool(_ddrManager.Object, _logger.Object);
        ...
        [Test]
        public async Task UpdateChapterSummary_DdrNotFound_ReturnsError()
        {
        ...
        [Test]
        public async Task UpdateChapterSummary_ChapterNotFound_ReturnsError()
        {
        ...
        [Test]
        public async Task UpdateChapterSummary_Valid_UpdatesSummary()
        {
            ...
            Assert.That(chapter.Summary, Is.EqualTo("New summary"));
            Assert.That(result.Result, Does.Contain("\"ok\":true"));
        }

        [Test]
        public void UpdateChapterSummary_GetSchema_ReturnsObject()
        {
            var schema = UpdateChapterSummaryAgentTool.GetSchema();
