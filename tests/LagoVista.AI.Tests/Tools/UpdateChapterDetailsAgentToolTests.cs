...
{
    [TestFixture]
    public class UpdateChapterDetailsAgentToolTests
    {
        ...
        [Test]
        public async Task UpdateChapterDetails_MissingIdentifier_ReturnsError()
        {
            var tool = new UpdateChapterDetailsAgentTool(_ddrManager.Object, _logger.Object);
        ...
        [Test]
        public async Task UpdateChapterDetails_MissingChapterId_ReturnsError()
        {
            var tool = new UpdateChapterDetailsAgentTool(_ddrManager.Object, _logger.Object);
        ...
        [Test]
        public async Task UpdateChapterDetails_DdrNotFound_ReturnsError()
        {
        ...
        [Test]
        public async Task UpdateChapterDetails_ChapterNotFound_ReturnsError()
        {
        ...
        [Test]
        public async Task UpdateChapterDetails_Valid_UpdatesDetails()
        {
            ...
            Assert.That(chapter.Details, Is.EqualTo("New details"));
            Assert.That(result.Result, Does.Contain("\"ok\":true"));
        }

        [Test]
        public void UpdateChapterDetails_GetSchema_ReturnsObject()
        {
            var schema = UpdateChapterDetailsAgentTool.GetSchema();
