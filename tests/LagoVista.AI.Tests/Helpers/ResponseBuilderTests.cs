...
namespace LagoVista.AI.Tests.Helpers
{
    ...
    public class ResponseBuilderTests
    {
        private sealed class TestPipelineContext : IAgentPipelineContext
        {
            ...
            public void AttachAgentContext(AgentContext context, AgentContextRole conversationContext, AgentMode mode)
            {
        ...
        private IAgentExecuteResponseBuilder CreateBuilder(bool isValid = true)
        {
            ...
            {
                validator.Setup(val => val.ValidateCore(It.IsAny<IAgentPipelineContext>(), It.IsAny<PipelineSteps>(), It.IsAny<bool>())).Returns(InvokeResult.FromError("error"));
