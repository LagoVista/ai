...
namespace LagoVista.AI.Rag.ContractPacks.Ingestion.Services
{
    ...
    public class IndexIdServices : IIndexIdServices
    {
        ...
        /// </summary>
        public string BuildCanonicalPath(string projectId, string pathInRepo)
        {
        ...
        /// </summary>
        public string BuildCanonicalString(string repoUrl, string canonicalPath)
        {
            if (string.IsNullOrWhiteSpace(repoUrl))
                throw new ArgumentNullException(nameof(repoUrl));
        ...
        /// </summary>
        public string ComputeDocId(string repoUrl, string canonicalPath)
        {
        ...
        /// compute DocId.
        /// </summary>
        public string ComputeDocId(string repoUrl, string projectId, string pathInRepo)
        {
