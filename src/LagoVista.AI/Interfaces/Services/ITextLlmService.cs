...
namespace LagoVista.AI.Interfaces.Services
{
    ...
    /// </summary>
    public interface ITextLlmService
    {
        /// <summary>
        /// Non-generic convenience overload for simple string scenarios.
        /// Conceptually equivalent to ExecuteAsync&lt;string&gt;.
        /// </summary>
        /// <param name="systemPrompt">OriginalInstructions describing how the model should behave.</param>
        ...
        Task<InvokeResult<string>> ExecuteAsync(string systemPrompt, string inputText, string model, string operationName, string correlationId,
            CancellationToken cancellationToken = default);
    }
}
