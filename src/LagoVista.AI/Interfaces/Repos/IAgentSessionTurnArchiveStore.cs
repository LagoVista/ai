...
namespace LagoVista.AI.Interfaces.Repos
{
    ...
    {
        Task<AgentSessionArchive> SaveAsync(AgentSession session, IReadOnlyList<AgentSessionTurn> turns, string title, EntityHeader user, CancellationToken ct = default);
