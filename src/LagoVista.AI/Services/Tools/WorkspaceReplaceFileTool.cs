...
namespace LagoVista.AI.Services.Tools
{
    ...
    /// </summary>
    public class WorkspaceReplaceFileTool : IAgentTool
    {
        public const string ToolName = "workspace_replace_file";
        private readonly IAdminLogger _logger;
        public bool IsToolFullyExecutedOnServer => false;

        public WorkspaceReplaceFileTool(IAdminLogger logger)
        {
            _logger = logger ?? throw new ArgumentNullException(nameof(logger));
        }

        public const string ToolSummary = "replace a file on the user machine with a client side tool";
...
workspace_replace_file — Usage Guide
