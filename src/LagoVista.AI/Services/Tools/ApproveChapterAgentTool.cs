...
namespace LagoVista.AI.Services.Tools
{
    ...
    public class ApproveChapterAgentTool : DdrAgentToolBase
    {
        ...
        public ApproveChapterAgentTool(IDdrManager ddrManager, IAdminLogger adminLogger) : base(ddrManager, adminLogger)
        {
        }

        public const string ToolUsageMetadata = "Approves a DDR chapter once its content is complete. Marks the chapter as finalized. Requires explicit user approval.";
        ...
        {
            return ToolSchema.Function(ToolName, "Approve a specific DDR chapter, recording approver and timestamp. Use this after the chapter content is stable.", p =>
            {
