...
namespace LagoVista.AI.Services.Tools
{
    ...
    public class SetDdrStatusAgentTool : DdrAgentToolBase
    {
        ...
        public const string ToolUsageMetadata = "Updates the DDR�s lifecycle status (Draft, InProgress, ReadyForApproval, Approved, Rejected, Tabled). Use to reflect progress or workflow transitions.";
