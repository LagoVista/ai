...
namespace LagoVista.AI.Services
{
    ...
    public class OpenAISessionNamingService : IAgentSessionNamingService
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _agentStreamingContext.AddWorkflowAsync("thinking of a good name for this session...");
            ...
            await _agentStreamingContext.AddWorkflowAsync($"got it, let's call it {result.Result}...");
