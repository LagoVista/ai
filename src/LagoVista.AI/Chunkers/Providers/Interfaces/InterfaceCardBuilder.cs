...
public static class InterfaceCardBuilder
{
    public static string BuildInterfaceCard(InterfaceDescription iface, string sourcePath = null, int maxMethods = 50, int maxProps = 50)
    {
        ...
        if (methods.Count > 0)
        {
            ...
            foreach (var m in methods)
            {
                ...
                var atom = InterfaceFinderSnippetBuilder.BuildMethodAtom(m);
