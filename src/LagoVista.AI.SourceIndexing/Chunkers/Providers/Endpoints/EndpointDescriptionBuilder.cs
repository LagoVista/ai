...
namespace LagoVista.AI.Chunkers.Providers.Endpoints
{
    /// <summary>
    ...
    /// </summary>
    public class EndpointDescriptionBuilder : IDescriptionBuilder
    {
        public string Name => nameof(EndpointDescriptionBuilder);

        public string Description => "Create a full indexable description of HTTP endpoints from C# controller source code.";


        public Task<InvokeResult<IRagDescription>> BuildAsync(IndexFileContext fileContext, string symbolText, IDomainCatalogService domainCatalogService, IResourceDictionary resourceDictionary)
        {
        ...
        public InvokeResult<IReadOnlyList<EndpointDescription>> CreateEndpointDescriptions(IndexFileContext ctx, string sourceText)
        {
