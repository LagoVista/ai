...
namespace LagoVista.Core.AI.Models
{
    ...
    /// </summary>
    public sealed class AgentExecuteResponseV2
    {
        /// <summary>
        ...
        public List<AgentToolCallV2> ToolCalls { get; set; }
        ...
        public List<AgentToolResultV2> ToolResults { get; set; }
        ...
        public List<FileRefV2> Files { get; set; }
        ...
        public LlmUsageV2 Usage { get; set; }
    }
    ...
    /// </summary>
    public sealed class AgentToolCallV2
    {
    ...
    /// </summary>
    public sealed class AgentToolResultV2
    {
        [JsonProperty("toolCallId")]
        public string ToolCallId { get; set; }
    ...
    public sealed class LlmUsageV2
    {
